...
宏观分析的核心在于理解 **流动性 (Liquidity)** 的方向。在 [[Investment_First_Principles|投资第一性原理]] 中，我们知道 $P = EPS \times PE$。如果说企业基本面决定 EPS，那么宏观环境主要通过影响流动性来决定 **PE (估值倍数)** 的扩张或收缩。

## 核心概念体系

### 1. 资产定价之锚
一切金融分析的起点。为什么美债收益率的波动能引发全球市场的海啸？
*   [[Ten_Year_Treasury|10年期美债：全球资产定价之锚]] - 理解 $R_f$、DCF 模型与"杀估值"逻辑。

### 2. 政策制定者 (庄家)
谁在控制流动性的水龙头？
*   [[Fed_Mechanics|美联储机制：双重使命与点阵图]] - 了解 Fed 的目标、工具以及"Don't Fight the Fed"的含义。

### 3. 导航仪表盘
如何预判美联储的动作？我们需要看懂他们看的数据。
*   [[Economic_Indicators|关键数据：PCE 与 非农就业]] - 解读通胀与就业数据，以及"好消息就是坏消息"的市场博弈逻辑。
...
*   [[Evolution_of_Money|货币演变史]] - 从以物易物到数字货币。
